...
static const struct adsp_desc bxt_dsp_desc = {
    ...
    .num_ssp = 3,
    .num_dmac = 2,
    .iram = {.base = 0xFF2C0000, .size = 0x14000},
    .dram0 = {.base = 0xff300000, .size = 0x28000},

    .mbox_dev = {
        .name = "mbox",
        .reg_count = ARRAY_SIZE(adsp_mbox_map),
        .reg = adsp_mbox_map,
        .desc = {.base = 0xFF344000, .size = 0x1000},
    },
    ...
    .shim_dev = {
        ...
        .desc = {.base = 0xFF340000, .size = 0x4000},
    },
    ...
    .gp_dmac_dev[0] = {
        ...
        .reg = adsp_gp_dma_map,
        .desc = {.base = 0xFF298000, .size = 0x00004000},
    },
    .gp_dmac_dev[1] = {
        .name = "dmac1",
        .reg_count = ARRAY_SIZE(adsp_gp_dma_map),
        .reg = adsp_gp_dma_map,
        .desc = {.base = 0xFF29C000, .size = 0x00004000},
    },
    .ssp_dev[0] = {
        .name = "ssp0",
        .reg_count = ARRAY_SIZE(adsp_ssp_map),
        .reg = adsp_ssp_map,
        .desc = {.base = 0xFF2A0000, .size = 0x00001000},
    },
    .ssp_dev[1] = {
        .name = "ssp1",
        .reg_count = ARRAY_SIZE(adsp_ssp_map),
        .reg = adsp_ssp_map,
        .desc = {.base = 0xFF2A1000, .size = 0x00001000},
    },
    .ssp_dev[2] = {
        .name = "ssp2",
        .reg_count = ARRAY_SIZE(adsp_ssp_map),
        .reg = adsp_ssp_map,
        .desc = {.base = 0xFF2A2000, .size = 0x00001000},
    },
