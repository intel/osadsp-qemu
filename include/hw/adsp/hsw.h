...
#define ADSP_HSW_HOST_IRAM_BASE     (ADSP_HSW_MMIO_BASE + ADSP_HSW_HOST_IRAM_OFFSET)
#define ADSP_HSW_HOST_DRAM_BASE     (ADSP_HSW_MMIO_BASE + ADSP_HSW_HOST_DRAM_OFFSET)
...
#define ADSP_BDW_HOST_IRAM_BASE     (ADSP_BDW_MMIO_BASE + ADSP_BDW_HOST_IRAM_OFFSET)
#define ADSP_BDW_HOST_DRAM_BASE     (ADSP_BDW_MMIO_BASE + ADSP_BDW_HOST_DRAM_OFFSET)
